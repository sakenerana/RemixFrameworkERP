...
export default function LocationsRoutes() {
  ...
  const editRecord = (record: Location) => {
    navigate(`/inventory/settings/form-location/${record.id}`);
  };
    ...
    <div className="w-full px-6 py-4 rounded-lg shadow-sm">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        ...
        <Space wrap className="mt-2 sm:mt-0">
          <Link to="/inventory/settings/deleted-location">
            <Button
          ...
          <Link to="/inventory/settings/form-location">
            <Button
              icon={<AiOutlinePlus />}
              type="primary"
            ...
            emptyText: (
              <div className="py-8 flex flex-col items-center">
                ...
                <Button
                  type="primary"
                  className="mt-4"
                  onClick={() => navigate('/inventory/settings/form-location')}
                >
