...
export const VIEW_STAFFS: Staff[] = [
    ...
    { id: '6', name: 'John Doe', tasks: 6500, taskCompleted: 18, replenishmentDays: 8, status: 'stable' },
];
                ...
                <div className="flex h-screen bg-[#f3f4f6] overflow-hidden">
                    ...
                    <div className="flex-1 flex flex-col min-w-0 overflow-y-auto">
                        ...
                        <main className="p-6 space-y-8">
                            {/* Views Section */}
                            <section>
                                <h2 className="text-[11px] font-bold text-gray-400 uppercase tracking-widest mb-4">Loan Release by Branches</h2>
