...
export default function LoanReleaseLayoutIndex() {
  ...
  useEffect(() => {
    if (currentPath === '/loanrelease') {
      navigate('/loanrelease/dashboard', { replace: true });
    }
  ...
  const menuItems: MenuProps['items'] = [
    {
      ...
      label: <Link to="/loanrelease/dashboard">Dashboard</Link>,
    },
  ];
