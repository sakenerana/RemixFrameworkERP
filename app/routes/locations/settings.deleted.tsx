...
export default function DeletedLocation() {
    ...
    const handleActivateButton = async (record: Location) => {
        const { error } = await LocationService.activateStatus(
            record.id,
            record
        );
    ...
    const fetchData = async () => {
        try {
            setLoading(true);
            const dataFetch = await LocationService.getAllPostsInactive(isDepartmentID);
    ...
    return (
        <div>
            ...
            <div className="flex justify-between">
                <Alert
                    message="Note: This is the list of all inactive locations. Please check closely."
                    type="info"
                    showIcon
                />
