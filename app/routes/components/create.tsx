...
import { Breadcrumb, Button, Card, Col, DatePicker, Divider, Form, Input, message, Modal, Row, Select } from "antd";
    ...
    const onFinish = async () => {
        try {
            ...
            if (id) {
                ...
                const { error } = await ComponentService.updatePost(Number(id), values);
