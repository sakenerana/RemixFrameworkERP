...
import { AiOutlineCalendar, AiOutlineClear, AiOutlineDown, AiOutlineRollback, AiOutlineSave, AiOutlineSend, AiOutlineShop, AiOutlineStock, AiOutlineTags, AiOutlineTool } from "react-icons/ai";
...
export default function CreateAccessory() {
    ...
    const fetchDataCategory = async () => {
        try {
            setLoading(true);
            const dataFetchGroup = await CategoryService.getAllPostsByAccessories(isDepartmentID);
    ...
    const onFinish = async () => {
        try {
            ...
            if (id) {
                await AccessoryService.updatePost(Number(id), formattedValues);
                message.success("Record updated successfully");
            } else {
                setLoading(true);
                await AccessoryService.createPost(formattedValues);
                ...
                >
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div className="space-y-4">
                            <Card type="inner" title={
                                ...
                                <Form.Item
                                    label={<span className="font-medium">Accessory Name <span className="text-red-500">*</span></span>}
                                    name="name"
                    ...
                    <div className="mt-6 w-full">
                        ...
                        >
                            <TextArea
                                rows={4}
                                placeholder="Additional notes about this accessory (optional)"
                    ...
                    <div className="flex flex-col-reverse sm:flex-row justify-end gap-3 border-t pt-6 mt-8 w-full">
                        ...
                        >
                            {isEditMode ? 'Update Accessory' : 'Create Accessory'}
                        </Button>
                    </div>
                </Form>
            </Card>
