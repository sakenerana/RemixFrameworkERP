...
export default function DeletedManufacturer() {
    ...
    const fetchData = async () => {
        try {
            setLoading(true);
            const dataFetch = await ManufacturerService.getAllPostsInactive(isDepartmentID);
    ...
    return (
        <div>
            ...
            <div className="flex justify-between">
                <Alert
                    message="Note: This is the list of all inactive manufacturers. Please check closely."
                    type="info"
                    showIcon
                />
