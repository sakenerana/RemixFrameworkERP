import { CalendarOutlined, CheckCircleOutlined, ExperimentOutlined, HomeOutlined, InfoCircleOutlined, LoadingOutlined, SettingOutlined } from "@ant-design/icons";
...
export default function ConsumablesRoute() {
  ...
  const editRecord = (record: Consumable) => {
    navigate(`/inventory/form-consumable/${record.id}`);
  };
    ...
    <Card className="w-full">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        ...
        <Space wrap className="mt-2 sm:mt-0">
          <Link to="/inventory/deleted-consumables">
            <Button
          ...
          <Link to="/inventory/form-consumable">
            <Button
              icon={<AiOutlinePlus />}
              type="primary"
            ...
            emptyText: (
              <div className="py-8 flex flex-col items-center">
                ...
                <Button
                  type="primary"
                  className="mt-2"
                  onClick={() => navigate('/inventory/form-consumable')}
                  icon={<AiOutlinePlus />}
                >
