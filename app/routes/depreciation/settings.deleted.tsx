...
export default function DeletedDepreciation() {
    ...
    const handleActivateButton = async (record: Depreciation) => {
            ...
            render: (_, record) => (
                <div className="flex">
                    ...
                    <Popconfirm
                        ...
                        description="Are you sure to activate this depreciation?"
                        okText="Yes"
                        cancelText="No"
    ...
    return (
        <div>
            ...
            <div className="flex justify-between">
                <Alert
                    message="Note: This is the list of all inactive depreciations. Please check closely."
                    type="info"
                    showIcon
                />
