...
export default function Checkedout() {
    ...
    const handleCheckinButton = (data: Accessories) => {
        setIsModalOpen(true);
        setDataRow(data);
    };
        ...
        try {
            ...
            if (values.checkin?.toLowerCase() === 'checkin') {
                try {
                    ...
                    const success = await AccessoryService.deleteAccessoriesCheck(Number(dataRow.id));
            ...
            render: (_, data) => (
                <div>
                    <Popconfirm
                        ...
                        description="Are you sure to checkin this accessories?"
                        okText="Yes"
                        cancelText="No"
