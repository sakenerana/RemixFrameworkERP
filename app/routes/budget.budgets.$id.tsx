import { HomeOutlined, LoadingOutlined, ArrowLeftOutlined } from "@ant-design/icons";
  ...
  useEffect(() => {
    const fetchBudget = async () => {
      ...
      try {
        setLoading(true);
        setError(null);
        const data = await BudgetService.getPostDetailsById(Number(id));
        setBudget(data);
      } catch (err) {
          ...
          <div className="flex min-w-0 items-start gap-4">
            ...
            <div className="min-w-0">
              ...
              <div className="mt-1 flex flex-wrap items-center gap-2 text-sm text-gray-500">
                <span>
                  Budget Period: {dayjs(budget.start_date).format("MMM D")} - {dayjs(budget.end_date).format("MMM D, YYYY")}
                </span>
