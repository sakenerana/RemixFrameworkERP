...
export default function AssetModelsRoutes() {
    ...
    const editRecord = (record: AssetModel) => {
        navigate(`/inventory/settings/form-asset-model/${record.id}`);
    };
        ...
        <div className="w-full px-4">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 py-2">
                ...
                <Space wrap className="mt-2 sm:mt-0">
                    <Link to="/inventory/settings/deleted-asset-model">
                        <Button
                    ...
                    <Link to="/inventory/settings/form-asset-model">
                        <Button
                            icon={<AiOutlinePlus />}
                            type="primary"
                        ...
                        emptyText: (
                            <div className="py-8 flex flex-col items-center">
                                ...
                                <Button
                                    type="primary"
                                    className="mt-4"
                                    onClick={() => navigate('/inventory/settings/form-asset-model')}
                                >
