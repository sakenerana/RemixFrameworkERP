...
export default function DeletedAccessory() {
    ...
    const fetchData = async () => {
        try {
            setLoading(true);
            const dataFetch = await AccessoryService.getAllPostsInactive(isDepartmentID);
    ...
    return (
        <div>
            ...
            <div className="flex justify-between">
                <Alert
                    message="Note: This is the list of all inactive accessories. Please check closely."
                    type="info"
                    showIcon
                />
