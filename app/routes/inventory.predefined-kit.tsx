...
export default function PredefinedKitRoute() {
  ...
  const editRecord = (record: PredefinedKit) => {
    navigate(`/inventory/form-predefined-kit/${record.id}`);
  };
    ...
    <div className="w-full px-6 py-4 rounded-lg shadow-sm">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        ...
        <Space wrap className="mt-2 sm:mt-0">
          <Link to="/inventory/deleted-predefined-kit">
            <Button
          ...
          <Link to="/inventory/form-predefined-kit">
            <Button
              icon={<AiOutlinePlus />}
              type="primary"
            ...
            emptyText: (
              <div className="py-8 flex flex-col items-center">
                ...
                <Button
                  type="primary"
                  className="mt-2"
                  onClick={() => navigate('/inventory/form-predefined-kit')}
                  icon={<AiOutlinePlus />}
                >
                  Create First Kit
                </Button>
