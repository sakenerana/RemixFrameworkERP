...
import { UnacceptedAssetReport } from "~/types/unaccepted_asset_report.type";

export default function UnacceptedAssetsReportRoutes() {
  const data: UnacceptedAssetReport[] = [
    {
      key: "1",
      name: "John Brown",
      product_key: "test",
  ...
  const columns: TableColumnsType<UnacceptedAssetReport> = [
    {
      title: "Name",
      dataIndex: "name",
      width: 120
  ...
  const onChange: TableProps<UnacceptedAssetReport>["onChange"] = (
    pagination,
    filters,
    sorter,
    extra
  ...
  return (
    <div>
      ...
      <div className="flex justify-between">
        <Alert
          message="Note: This is the list of all unaccepted assets. Please check closely."
          type="info"
          showIcon
        />
