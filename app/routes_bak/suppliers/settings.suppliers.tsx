import { CheckCircleOutlined, HomeOutlined, LoadingOutlined, SettingOutlined, ShopOutlined } from "@ant-design/icons";
import {
  Alert,
  Breadcrumb,
  Button,
            ...
            emptyText: (
              <div className="py-8 flex flex-col items-center">
                ...
                <Button
                  type="primary"
                  className="mt-2"
                  onClick={() => navigate('/inventory/settings/suppliers/form-supplier')}
                  icon={<AiOutlinePlus />}
                >
                  Add First Supplier
                </Button>
